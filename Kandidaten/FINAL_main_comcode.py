...
def RXTX_messages(client_sock, status, send_thread):
    ...
    while True:
        try:
            ...
            elif str(data[14]).isdigit(): # Receiveing route
                now = datetime.now()
                current_time = now.strftime("%H:%M:%S:%f")[:-3]
...
while True:
    try:
        ...
        if server_sock:
            server_sock.close()
        break
#11:49:43.206_180060_PS_330060_330000_420000_PN_450000_450150_510150_PS_510210_570210_PE_360210_360180_PW_360150_180150_180090_000090_D_F